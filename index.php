...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark elegant-color">
        <a class="navbar-brand" href="#returntotop"></a>
    ...
    <div class="container mt-5 mainarea">

        <!-- Material form login -->
        <div class="card">

            <h5 class="card-header deep-orange darken-2 white-text text-center py-4">
            ...
            <div class="card-body px-lg-5 pt-0">
                ...
                <!-- Form -->
                <form class="text-center" style="color: #2a2a2e;" action="#!">
                    ...
                    <button class="btn btn-outline-dark btn-rounded btn-block my-4 waves-effect z-depth-0 btsbutton mt-1 m-auto" 
                        type="submit">Se connecter</button></div>
...
<footer class="page-footer font-small elegant-color pt-4 mt-5 fixed-bottom">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-4">
        ...
        <form class="input-group">
          <input type="text" class="form-control form-control-sm" placeholder="Votre e-mail"
  ...
  <div class="footer-copyright text-center py-3">© 2020 Copyright:
    <a href="anglisfun.tv"> Tristan Da Costa Pinto</a>
  </div>
  <!-- Copyright -->
