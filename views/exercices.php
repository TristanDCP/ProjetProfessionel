...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
            <a class="nav-link waves-effect waves-light" href="homepage.php"><img
                    src="/assets/img/LogoAnglisfunSM.png" alt="Logo arbre d'automne anglisfun"></a>
        </div>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
    ...
    <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="navbarDropdownMenuLink-4">
          ...
          <a class="dropdown-item" href="#">Leçon 5</a>
        </div>
      </li>
      <li class="nav-item">
    ...
    <div class="container mt-5 text-center">
       <video controls width="250">
           <source src="assets\media\videos\Royale With Cheese - Pulp Fiction.mp4" type="video/mp4">
           <source src="assets\media\videos\Royale With Cheese - Pulp Fiction.webm" type="video/webm">      
       </video>
